...
window.addEventListener('load', function () {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _autoOrValue, _autoOrValue2, _autoOrValue3, _autoOrValue4, _Number;

      var slider = _step.value;

      var autoOrValue = function autoOrValue(v) {
        return v === 'auto' ? v : isNaN(Number(v)) ? undefined : Number(v);
      };
      ...
      console.log((_autoOrValue = autoOrValue(slidesToShow)) !== null && _autoOrValue !== void 0 ? _autoOrValue : 1);
      console.log((_autoOrValue2 = autoOrValue(slidesToScroll)) !== null && _autoOrValue2 !== void 0 ? _autoOrValue2 : 1);
      new Glider(slider, {
        slidesToShow: (_autoOrValue3 = autoOrValue(slidesToShow)) !== null && _autoOrValue3 !== void 0 ? _autoOrValue3 : 1,
        slidesToScroll: (_autoOrValue4 = autoOrValue(slidesToScroll)) !== null && _autoOrValue4 !== void 0 ? _autoOrValue4 : 1,
