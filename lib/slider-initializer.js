  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var _slider$dataset = slider.dataset,
          ...
          dots = _slider$dataset.dots,
          arrows = _slider$dataset.arrows;
      new Glider(slider, {
...
window.addEventListener('load', function () {
  var editor = document.getElementById('editor'); // Para criar sliders no editor toda vez que o bloco mudar da edição (onde mostra apenas os inputs) para a visualização
...
window.addEventListener('ufr-block-dependencies-slides-rendered', createSliders);
window.ufrGlobals.blockScripts.createSliders = createSliders;